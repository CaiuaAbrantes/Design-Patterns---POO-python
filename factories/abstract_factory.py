...
class Cliente:
    def _busca_clientes(self, type: ZonaNorteVeiculoFactory | ZonaSulVeiculoFactory):
        for factory in [type]:
            ...
            moto_popular = factory.get_moto_luxo()
    ...
    def busca_clientes_zn(self):
        self._busca_clientes(type=ZonaNorteVeiculoFactory())

    def busca_clientes_zs(self):
        self._busca_clientes(type=ZonaSulVeiculoFactory())
